...
**Fuente de diseño (obligatoria):** Figma — [Design system / Buttons](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=2-7813&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `2:7813`

## Objetivo

Revisar y alinear el átomo **Buttons** (variantes y estados) con Figma y tokens.

## Modo de trabajo (revisión — vista existente)

La implementación base **ya existe** en el catálogo:

- Vista: `desarrollo-listo/src/app/components/buttons-view.tsx`
- Ruta actual (referencia): `/atoms`
...
1. **`get_design_context`** con `nodeId: "2:7813"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CHANGE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_06_buttons_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `2:7813` validada contra `get_screenshot`.

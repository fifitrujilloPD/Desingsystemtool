...
**Fuente de diseño (obligatoria):** Figma — [Design system / Dividers](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=3031-40774&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `3031:40774`

## Objetivo

Implementar el átomo **Dividers** (separadores horizontales/verticales) en el catálogo Atoms según Figma.
...
1. **`get_design_context`** con `nodeId: "3031:40774"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_07_motion_dividers_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `3031:40774` validada contra `get_screenshot`.

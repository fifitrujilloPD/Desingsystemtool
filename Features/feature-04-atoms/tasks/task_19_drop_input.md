...
**Fuente de diseño (obligatoria):** Figma — [Design system / Drop input](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=2-8532&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `2:8532`

## Objetivo

Implementar el átomo **Drop input** (dropdown / select trigger) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "2:8532"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_19_drop_input_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `2:8532` validada contra `get_screenshot`.

...
**Fuente de diseño (obligatoria):** Figma — [Design system / Badges](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=3-8722&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `3:8722`

## Objetivo

Revisar y alinear el átomo **Badges** con Figma y tokens semánticos.

## Modo de trabajo (revisión — vista existente)

La implementación base **ya existe** en el catálogo:

- Vista: `desarrollo-listo/src/app/components/badges-view.tsx`
- Ruta actual (referencia): `/atoms/badges`
...
1. **`get_design_context`** con `nodeId: "3:8722"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CHANGE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_05_badges_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `3:8722` validada contra `get_screenshot`.

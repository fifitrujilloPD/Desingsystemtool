...
**Fuente de diseño (obligatoria):** Figma — [Design system / Steppers](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=167-66289&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `167:66289`

## Objetivo

Implementar el átomo **Steppers** (pasos complete/active/pending) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "167:66289"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_11_steppers_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `167:66289` validada contra `get_screenshot`.

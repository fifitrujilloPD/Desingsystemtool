...
**Fuente de diseño (obligatoria):** Figma — [Design system / Breadcrumbs](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=981-286037&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `981:286037`

## Objetivo

Implementar el átomo **Breadcrumbs** en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "981:286037"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_16_breadcrumbs_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `981:286037` validada contra `get_screenshot`.

...
**Fuente de diseño (obligatoria):** Figma — [Design system / Date picker](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=977-294082&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `977:294082`

## Objetivo

Implementar el átomo **Date picker** (input + calendario) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "977:294082"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_21_date_picker_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `977:294082` validada contra `get_screenshot`.

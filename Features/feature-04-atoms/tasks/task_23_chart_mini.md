...
**Fuente de diseño (obligatoria):** Figma — [Design system / Chart mini](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=982-291981&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `982:291981`

## Objetivo

Implementar el átomo **Chart mini** en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "982:291981"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_23_chart_mini_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `982:291981` validada contra `get_screenshot`.

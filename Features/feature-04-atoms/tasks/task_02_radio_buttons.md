# Task 02 — Radio buttons

**Feature:** 04 Atoms  
**Agente:** `@Agents/fullstack-design-system` (implementación) + `@Agents/metodologia-sdd` (cierre)  
**Fuente de diseño (obligatoria):** Figma — [Design system / Radio buttons](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=7-16556&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `7:16556`

## Objetivo

Revisar y alinear el átomo **Radio buttons** (selección única en grupo) con el frame Figma y los tokens del DS.

## Modo de trabajo (revisión — vista existente)

La implementación base **ya existe** en el catálogo:

- Vista: `desarrollo-listo/src/app/components/radio-button-view.tsx`
- Ruta actual (referencia): `/atoms/radio-buttons`
...
1. **`get_design_context`** con `nodeId: "7:16556"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CHANGE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_02_radio_buttons_<fecha>.md`.
...
- [x] Vista alineada al frame Figma `7:16556` validada contra `get_screenshot`.

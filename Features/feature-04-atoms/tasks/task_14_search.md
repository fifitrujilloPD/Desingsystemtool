...
**Fuente de diseño (obligatoria):** Figma — [Design system / Search](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=241-123115&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `241:123115`

## Objetivo

Implementar el átomo **Search** (campo de búsqueda con icono/clear) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "241:123115"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_14_search_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `241:123115` validada contra `get_screenshot`.

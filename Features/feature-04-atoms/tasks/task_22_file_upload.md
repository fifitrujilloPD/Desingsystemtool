...
**Fuente de diseño (obligatoria):** Figma — [Design system / File upload](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=978-299120&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `978:299120`

## Objetivo

Implementar el átomo **File upload** (base) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "978:299120"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_22_file_upload_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `978:299120` validada contra `get_screenshot`.

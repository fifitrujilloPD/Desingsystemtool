# Task 10 — Circle progress

**Feature:** 04 Atoms  
**Agente:** `@Agents/fullstack-design-system` (implementación) + `@Agents/metodologia-sdd` (cierre)  
**Fuente de diseño (obligatoria):** Figma — [Design system / Circle progress](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=978-298965&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `978:298965`

## Objetivo

Implementar el átomo **Circle progress** en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "978:298965"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_10_circle_progress_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `978:298965` validada contra `get_screenshot`.

...
**Fuente de diseño (obligatoria):** Figma — [Design system / Side tabs](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=131-69223&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `131:69223`

## Objetivo

Implementar el átomo **Side tabs** (pestañas laterales / rail) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "131:69223"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_15_side_tabs_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `131:69223` validada contra `get_screenshot`.

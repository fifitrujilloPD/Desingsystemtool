...
**Fuente de diseño (obligatoria):** Figma — [Design system / Inputs](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=2-8432&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `2:8432`

## Objetivo

Revisar y alinear el átomo **Inputs** (estados, labels, tokens) con Figma.

## Modo de trabajo (revisión — vista existente)

La implementación base **ya existe** en el catálogo:

- Vista: `desarrollo-listo/src/app/components/inputs-view.tsx`
- Ruta actual (referencia): `/atoms/inputs`
...
1. **`get_design_context`** con `nodeId: "2:8432"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CHANGE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_04_inputs_<fecha>.md`.
...
- [x] Vista alineada al frame Figma `2:8432` validada contra `get_screenshot`.

# Task 09 — Bar progress

**Feature:** 04 Atoms  
**Agente:** `@Agents/fullstack-design-system` (implementación) + `@Agents/metodologia-sdd` (cierre)  
**Fuente de diseño (obligatoria):** Figma — [Design system / Bar progress](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=977-298525&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `977:298525`

## Objetivo

Implementar el átomo **Bar progress** (determinate/indeterminate) en el catálogo Atoms.
...
1. **`get_design_context`** con `nodeId: "977:298525"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_09_bar_progress_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `977:298525` validada contra `get_screenshot`.

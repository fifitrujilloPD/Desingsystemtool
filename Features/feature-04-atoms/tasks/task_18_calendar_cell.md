# Task 18 — Calendar cell

**Feature:** 04 Atoms  
**Agente:** `@Agents/fullstack-design-system` (implementación) + `@Agents/metodologia-sdd` (cierre)  
**Fuente de diseño (obligatoria):** Figma — [Design system / Calendar cell](https://www.figma.com/design/Oe6iEqTP8ieLJrSa5zHE0a/Design-system--Copy-?node-id=981-282277&t=IlFtdNLpuU9YgPZu-4)  
**Node ID Figma:** `981:282277`

## Objetivo

Implementar el átomo **Calendar cell** como building block reutilizable por Date picker.
...
1. **`get_design_context`** con `nodeId: "981:282277"`, `clientLanguages: "typescript,tsx,css"`, `clientFrameworks: "react,tailwind,vite"`, `artifactType: "DESIGN_SYSTEM"`, `taskType: "CREATE_ARTIFACT"`.
...
4. Evidencia MCP (`get_screenshot`) referenciada en `Ejecuciones/ejecucion_feature_04_task_18_calendar_cell_<fecha>.md`.
...
- [ ] Vista alineada al frame Figma `981:282277` validada contra `get_screenshot`.
